DROP TABLE IF EXISTS analytical.a_pem_delta;
CREATE EXTERNAL TABLE analytical.a_pem_delta (
id string,
cpf string,
...
LOCATION 'abfs://azhdisimuseprd@azsimdtlkprd.dfs.core.windows.net/data/analytical/a_pem_delta';