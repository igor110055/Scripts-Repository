use harmonized;
DROP TABLE IF EXISTS h_baldemanual_cetip_historico;
CREATE EXTERNAL TABLE h_baldemanual_cetip_historico (
no_cpf STRING,
tp_documento INT,
ds_documento STRING,
...
LOCATION
'abfs://azhdisimuseprd@azsimdtlkprd.dfs.core.windows.net/data/harmonized/BaldeManual/h_baldemanual_cetip_historico/'
