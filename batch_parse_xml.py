...
if __name__ == "__main__":
   conf = SparkConf().setAppName("allcheck")
   sc = SparkContext(conf=conf)
   spark = SparkSession.builder.appName("allcheck").getOrCreate()
...
def gera_arquivo(nome_diretorio,nome_arquivo,nome_arquivo_final):
   ...
   args = "hdfs dfs -ls "+v_blob_spark+"/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/"+nome_diretorio+"/*.csv | awk '{print $9}'"
   proc = subprocess.Popen(args, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
   s_output, s_err = proc.communicate()
   all_dart_dirs = s_output.split()
   sed = "sed 's/|/\n/g'"
   for line in all_dart_dirs:
      args_trata = "hadoop fs -cat "+line+" |  "+repr(sed)+" | hadoop fs -appendToFile - /data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/"+nome_diretorio+"/"+nome_arquivo+".csv"
   ...
   args_cabecalho = "hdfs dfs -ls "+v_blob_spark+"/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/"+nome_diretorio+"/cabecalho/*.csv | awk '{print $9}'"
   ...
   for line_cabecalho in all_dart_dirs_cabecalho:
      args_trata_cabecalho = 'hadoop fs -cat '+line_cabecalho+' |  sed -n "1p" | hadoop fs -put -f - /data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/'+ano+mes+dia+'/'+nome_diretorio+'/cabecalho/tratado.csv'
   ...
   args_final = "hadoop fs -cat "+v_blob_spark+"/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/"+nome_diretorio+"/cabecalho/tratado.csv abfs://sparkazredhdi-dev@azredlake.dfs.core.windows.net/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/"+nome_diretorio+"/"+nome_arquivo+".csv | hadoop fs -put -f - abfs://sparkazredhdi-dev@azredlake.dfs.core.windows.net/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/"+nome_diretorio+"/"+nome_arquivo_final+".csv"
...
try:
      rdd = sc.wholeTextFiles("/data/raw/FICO/AllCheckAnaliseFullOutput/detalhado/"+ano+mes+dia+"/*.txt")
      ...
      df_numeroConsulta.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/numeroConsulta")
      ...
      df_numeroConsulta_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/numeroConsulta/cabecalho")
      ...
      if lst_dadosCadastrais.isEmpty() == False:
         ...
         df_dadosCadastrais.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/dadosCadastrais")
         ...
         df_dadosCadastrais_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/dadosCadastrais/cabecalho")
      ...
      if lst_consta_obito.isEmpty() == False:
         ...
         df_consta_obito.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_obito")
         ...
         df_consta_obito_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_obito/cabecalho")
      ...
      if lst_telefone.isEmpty() == False:
         ...
         df_novo_telefone.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novoTelefone")
         ...
         df_novo_telefone_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novoTelefone/cabecalho")
      ...
      if lst_novo_socios.isEmpty() == False:
         ...
         df_novo_socios.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_socios")
         ...
         df_novo_socios_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_socios/cabecalho")
      ...
      if lst_empresas.isEmpty() == False:
         ...
         df_empresas.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/empresas")
         ...
         df_empresas_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/empresas/cabecalho")
      ...
      if lst_novo_veiculo.isEmpty() == False:
         ...
         df_novo_veiculo.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_veiculo")
         ...
         df_novo_veiculo_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_veiculo/cabecalho")
      ...
      if lst_novo_ccf.isEmpty() == False:
         ...
         df_novo_ccf.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_ccf")
         ...
         df_novo_ccf_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_ccf/cabecalho")
      ...
      if lst_novo_dadosBancarios.isEmpty() == False:
         ...
         df_novo_dadosBancarios.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_dadosBancarios")
         ...
         df_novo_dadosBancarios_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_dadosBancarios/cabecalho")

         gera_arquivo("novo_dadosBancarios","arquivo_novo_dadosBancarios","arquivo_novo_dadosBancarios_final")

      #novo_detalhadoTrabalho
      lst_novo_detalhadoTrabalho = rdd.map(lambda (string_file): parser_xml(string_file[1],"novo_detalhadoTrabalho","detalhadoTrabalho","nomeEmpresa")).filter(lambda x: x is not None).filter(lambda x: x != "").filter(lambda x: x).filter(bool)
      if lst_novo_detalhadoTrabalho.isEmpty() == False:
         df_novo_detalhadoTrabalho = spark.createDataFrame(lst_novo_detalhadoTrabalho)
         df_novo_detalhadoTrabalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_detalhadoTrabalho")

         novo_detalhadoTrabalho_cabecalho = rdd.map(lambda (string_file): parser_xml_cabecalho(string_file[1],"novo_detalhadoTrabalho","detalhadoTrabalho","nomeEmpresa")).filter(lambda x: x is not None).filter(lambda x: x != "").filter(lambda x: x).filter(bool)
         df_novo_detalhadoTrabalho_cabecalho = spark.createDataFrame(novo_detalhadoTrabalho_cabecalho)
         df_novo_detalhadoTrabalho_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_detalhadoTrabalho/cabecalho")

         gera_arquivo("novo_detalhadoTrabalho","arquivo_novo_detalhadoTrabalho","arquivo_novo_detalhadoTrabalho_final")
      ...
      if lst_registro.isEmpty() == False:
         ...
         df_registro.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/registro")
         ...
         df_registro_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/registro/cabecalho")
      ...
      if lst_consta_ppe.isEmpty() == False:
         ...
         df_consta_ppe.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppe")
         ...
         df_consta_ppe_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppe/cabecalho")
      ...
      if lst_consta_ppebens.isEmpty() == False:
         ...
         df_consta_ppebens.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppebens")
         ...
         df_consta_ppebens_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppebens/cabecalho")
      ...
      if lst_consta_tcu.isEmpty() == False:
         ...
         df_consta_tcu.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_tcu")
         ...
         df_consta_tcu_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_tcu/cabecalho")
      ...
      if lst_consta_ceis.isEmpty() == False:
         ...
         df_consta_ceis.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ceis")
         ...
         df_consta_ceis_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ceis/cabecalho")
      ...
      if lst_consta_cepim.isEmpty() == False:
         ...
         df_consta_cepim.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_cepim")
         ...
         df_consta_cepim_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_cepim/cabecalho")
      ...
      if lst_consta_mte.isEmpty() == False:
         ...
         df_consta_mte.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_mte")
         ...
         df_consta_mte_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_mte/cabecalho")
      ...
      if lst_consta_parentesco.isEmpty() == False:
         ...
         df_consta_parentesco.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_parentesco")
         ...
         df_consta_parentesco_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_parentesco/cabecalho")
      ...
      if lst_consta_beneficio.isEmpty() == False:
         ...
         df_consta_beneficio.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_beneficio")
         ...
         df_consta_beneficio_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_beneficio/cabecalho")
      ...
      if lst_consta_servidor_federal.isEmpty() == False:
         ...
         df_consta_servidor_federal.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_servidor_federal")
         ...
         df_consta_servidor_federal_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_servidor_federal/cabecalho")
      ...
      if lst_consta_ceaf.isEmpty() == False:
         ...
         df_consta_ceaf.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ceaf")
         ...
         df_consta_ceaf_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ceaf/cabecalho")
      ...
      if lst_consta_possivel_morador.isEmpty() == False:
         ...
         df_consta_possivel_morador.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_possivel_morador")
         ...
         df_consta_possivel_morador_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_possivel_morador/cabecalho")
      ...
      if lst_consta_email.isEmpty() == False:
         ...
         df_consta_email.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_email")
         ...
         df_consta_email_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_email/cabecalho")
      ...
      if lst_consta_ppeparentesco.isEmpty() == False:
         ...
         df_consta_ppeparentesco.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppeparentesco")
         ...
         df_consta_ppeparentesco_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppeparentesco/cabecalho")
      ...
      if lst_novo_ancine.isEmpty() == False:
         ...
         df_novo_ancine.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_ancine")
         ...
         df_novo_ancine_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_ancine/cabecalho")
      ...
      if lst_novo_anttEmpresas.isEmpty() == False:
         ...
         df_novo_anttEmpresas.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_anttEmpresas")
         ...
         df_novo_anttEmpresas_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_anttEmpresas/cabecalho")
      ...
      if lst_novo_ans.isEmpty() == False:
         ...
         df_novo_ans.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_ans")
         ...
         df_novo_ans_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_ans/cabecalho")
      ...
      if lst_novo_anvisa.isEmpty() == False:
         ...
         df_novo_anvisa.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_anvisa")
         ...
         df_novo_anvisa_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_anvisa/cabecalho")
      ...
      if lst_novo_rabAnac.isEmpty() == False:
         ...
         df_novo_rabAnac.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_rabAnac")
         ...
         df_novo_rabAnac_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_rabAnac/cabecalho")
      ...
      if lst_novo_cnes.isEmpty() == False:
         ...
         df_novo_cnes.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_cnes")
         ...
         df_novo_cnes_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_cnes/cabecalho")
      ...
      if lst_novo_confea.isEmpty() == False:
         ...
         df_novo_confea.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_confea")
         ...
         df_novo_confea_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_confea/cabecalho")
      ...
      if lst_novo_coren.isEmpty() == False:
         ...
         df_novo_coren.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_coren")
         ...
         df_novo_coren_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_coren/cabecalho")
      ...
      if lst_novo_siccau.isEmpty() == False:
         ...
         df_novo_siccau.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_siccau")
         ...
         df_novo_siccau_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_siccau/cabecalho")
      ...
      if lst_novo_crosp.isEmpty() == False:
         ...
         df_novo_crosp.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_crosp")
         ...
         df_novo_crosp_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_crosp/cabecalho")
      ...
      if lst_novo_cfmv.isEmpty() == False:
         ...
         df_novo_cfmv.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_cfmv")
         ...
         df_novo_cfmv_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_cfmv/cabecalho")
      ...
      if lst_novo_cfc.isEmpty() == False:
         ...
         df_novo_cfc.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_cfc")
         ...
         df_novo_cfc_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_cfc/cabecalho")
      ...
      if lst_novo_telefone_fraude.isEmpty() == False:
         ...
         df_novo_telefone_fraude.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_telefone_fraude")
         ...
         df_novo_telefone_fraude_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_telefone_fraude/cabecalho")
      ...
      if lst_novo_anp.isEmpty() == False:
         ...
         df_novo_anp.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_anp")
         ...
         df_novo_anp_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/novo_anp/cabecalho")
      ...
      if lst_consta_ppePrestacaoContasDoador.isEmpty() == False:
         ...
         df_consta_ppePrestacaoContasDoador.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppePrestacaoContasDoador")
         ...
         df_consta_ppePrestacaoContasDoador_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_ppePrestacaoContasDoador/cabecalho")
      ...
      if lst_consta_endereco.isEmpty() == False:
         ...
         df_consta_endereco.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_endereco")
         ...
         df_consta_endereco_cabecalho.write.format("csv").option("sep","|").mode("overwrite").save("/data/raw/FICO/AllCheckAnaliseFullOutput/consolidado/"+ano+mes+dia+"/consta_endereco/cabecalho")
