...
try:
    ...
    # args_mkdir = "hdfs dfs -mkdir abfs://sparkazredhdi-dev@azredlake.dfs.core.windows.net/data/raw/FICO/PayloadPreAnaliseOutput/detalhado/"+ano+mes+dia
    ...
    # Para cada arquivo existe na pasta que esta sendo gerado o streaming, move o arquivo para a pasta de detalhado.
