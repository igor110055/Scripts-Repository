use harmonized;
DROP TABLE IF EXISTS h_baldemanual_cetip;	
CREATE EXTERNAL TABLE h_baldemanual_cetip (
no_cpf STRING,
tp_documento INT,
ds_documento STRING,
...
LOCATION
'abfs://azhdisimuseprd@azsimdtlkprd.dfs.core.windows.net/data/harmonized/BaldeManual/h_baldemanual_cetip/';