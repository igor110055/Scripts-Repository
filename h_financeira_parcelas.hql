USE harmonized;
DROP TABLE IF EXISTS h_financeira_parcelas;	
CREATE EXTERNAL TABLE h_financeira_parcelas (
...
LOCATION
'abfs://azhdisimuseprd@azsimdtlkprd.dfs.core.windows.net/data/harmonized/Financeira/h_financeira_parcelas/';